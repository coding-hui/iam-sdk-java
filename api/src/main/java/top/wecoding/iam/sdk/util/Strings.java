 ...
 * "https://github.com/spring-projects/spring-framework/blob/main/spring-core/src/main/java/org/springframework/util/StringUtils.java">SpringFramework</a>
 *
 * <p>
...
public abstract class Strings {
	...
	/**
	 * Trim <em>all</em> whitespace from the given {@code CharSequence}: leading,
	...
	/**
	 * Trim <em>all</em> whitespace from the given {@code String}: leading, trailing, and
	...
	/**
	 * format strings according to template placeholders
	 *
	 * <p>
	 * format("hello {}!", "world")
	 * @param str str
	...
	public static String format(String str, Object... arguments) {
		...
		for (int start, end; (start = str.indexOf(LEFT_BRACE, cursor)) != -1
				&& (end = str.indexOf(RIGHT_BRACE, start)) != -1 && index < argsLength;) {
	...
	public static String join(Object[] arr) {
		return Strings.arrayToCommaDelimitedString(arr);
	}
	...
	public static String join(Object[] arr, String delim) {
		return Strings.arrayToDelimitedString(arr, delim);
	}
	 ...
	 * {@code "Z"}, and {@code "0"} through {@code "9"} stay the same.
	...
	public static String uriDecode(String source, Charset charset) {
		...
		return (changed ? Streams.copyToString(baos, charset) : source);
	}

	/**
	 * Parse the given {@code String} value into a {@link Locale}, accepting the
	 * {@link Locale#toString} format as well as BCP 47 language tags as specified by
	 * {@link Locale#forLanguageTag}.
	 * @param localeValue the locale value: following either {@code Locale's}
	 * {@code toString()} format ("en", "en_UK", etc), also accepting spaces as separators
	 * (as an alternative to underscores), or BCP 47 (e.g. "en-UK")
	...
	public static String[] toStringArray(Collection<String> collection) {
		return (!Collections.isEmpty(collection) ? collection.toArray(EMPTY_STRING_ARRAY) : EMPTY_STRING_ARRAY);
	}
	...
	public static String[] toStringArray(Enumeration<String> enumeration) {
		return (enumeration != null ? toStringArray(java.util.Collections.list(enumeration)) : EMPTY_STRING_ARRAY);
	}
	 ...
	 * {@code
	 * Properties} instance is then generated, with the left of the delimiter providing
	 ...
	 * still be considered as a single delimiter string, rather than as a bunch of
